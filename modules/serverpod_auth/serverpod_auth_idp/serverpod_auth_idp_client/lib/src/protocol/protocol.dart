...
import 'providers/passkey/models/passkey_challenge_not_found_exception.dart'
    as _i12;
import 'providers/passkey/models/passkey_login_request.dart' as _i13;
import 'providers/passkey/models/passkey_public_key_not_found_exception.dart'
    as _i14;
import 'providers/passkey/models/passkey_registration_request.dart' as _i15;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i10.GoogleIdTokenVerificationException) {
      return _i10.GoogleIdTokenVerificationException.fromJson(data) as T;
    }
    if (t == _i11.PasskeyChallengeExpiredException) {
      return _i11.PasskeyChallengeExpiredException.fromJson(data) as T;
    }
    if (t == _i12.PasskeyChallengeNotFoundException) {
      return _i12.PasskeyChallengeNotFoundException.fromJson(data) as T;
    }
    if (t == _i13.PasskeyLoginRequest) {
      return _i13.PasskeyLoginRequest.fromJson(data) as T;
    }
    if (t == _i14.PasskeyPublicKeyNotFoundException) {
      return _i14.PasskeyPublicKeyNotFoundException.fromJson(data) as T;
    }
    if (t == _i15.PasskeyRegistrationRequest) {
      return _i15.PasskeyRegistrationRequest.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i10.GoogleIdTokenVerificationException?>()) {
      return (data != null
              ? _i10.GoogleIdTokenVerificationException.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i11.PasskeyChallengeExpiredException?>()) {
      return (data != null
              ? _i11.PasskeyChallengeExpiredException.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i12.PasskeyChallengeNotFoundException?>()) {
      return (data != null
              ? _i12.PasskeyChallengeNotFoundException.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i13.PasskeyLoginRequest?>()) {
      return (data != null ? _i13.PasskeyLoginRequest.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i14.PasskeyPublicKeyNotFoundException?>()) {
      return (data != null
              ? _i14.PasskeyPublicKeyNotFoundException.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i15.PasskeyRegistrationRequest?>()) {
      return (data != null
              ? _i15.PasskeyRegistrationRequest.fromJson(data)
              : null)
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i10.GoogleIdTokenVerificationException =>
        'GoogleIdTokenVerificationException',
      _i11.PasskeyChallengeExpiredException =>
        'PasskeyChallengeExpiredException',
      _i12.PasskeyChallengeNotFoundException =>
        'PasskeyChallengeNotFoundException',
      _i13.PasskeyLoginRequest => 'PasskeyLoginRequest',
      _i14.PasskeyPublicKeyNotFoundException =>
        'PasskeyPublicKeyNotFoundException',
      _i15.PasskeyRegistrationRequest => 'PasskeyRegistrationRequest',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i10.GoogleIdTokenVerificationException():
        return 'GoogleIdTokenVerificationException';
      case _i11.PasskeyChallengeExpiredException():
        return 'PasskeyChallengeExpiredException';
      case _i12.PasskeyChallengeNotFoundException():
        return 'PasskeyChallengeNotFoundException';
      case _i13.PasskeyLoginRequest():
        return 'PasskeyLoginRequest';
      case _i14.PasskeyPublicKeyNotFoundException():
        return 'PasskeyPublicKeyNotFoundException';
      case _i15.PasskeyRegistrationRequest():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'GoogleIdTokenVerificationException') {
      return deserialize<_i10.GoogleIdTokenVerificationException>(data['data']);
    }
    if (dataClassName == 'PasskeyChallengeExpiredException') {
      return deserialize<_i11.PasskeyChallengeExpiredException>(data['data']);
    }
    if (dataClassName == 'PasskeyChallengeNotFoundException') {
      return deserialize<_i12.PasskeyChallengeNotFoundException>(data['data']);
    }
    if (dataClassName == 'PasskeyLoginRequest') {
      return deserialize<_i13.PasskeyLoginRequest>(data['data']);
    }
    if (dataClassName == 'PasskeyPublicKeyNotFoundException') {
      return deserialize<_i14.PasskeyPublicKeyNotFoundException>(data['data']);
    }
    if (dataClassName == 'PasskeyRegistrationRequest') {
      return deserialize<_i15.PasskeyRegistrationRequest>(data['data']);
    }
