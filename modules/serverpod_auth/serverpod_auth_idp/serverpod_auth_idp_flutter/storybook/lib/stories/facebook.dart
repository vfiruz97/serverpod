...
extension on List<FacebookButtonStyle> {
  List<Option<FacebookButtonStyle>> asOptions() {
    return map((e) => Option(label: e.name, value: e)).toList();
  }
}

extension on List<FacebookButtonSize> {
  List<Option<FacebookButtonSize>> asOptions() {
    return map((e) => Option(label: e.name, value: e)).toList();
  }
}

extension on List<FacebookButtonShape> {
  List<Option<FacebookButtonShape>> asOptions() {
    return map((e) => Option(label: e.name, value: e)).toList();
  }
}

extension on List<FacebookButtonText> {
  List<Option<FacebookButtonText>> asOptions() {
    return map((e) => Option(label: e.name, value: e)).toList();
  }
}

extension on List<FacebookButtonLogoAlignment> {
  List<Option<FacebookButtonLogoAlignment>> asOptions() {
    return map((e) => Option(label: e.name, value: e)).toList();
  }
}
